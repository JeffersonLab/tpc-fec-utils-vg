...
public:
    ...
    ChannelReadout(
        ...
        if (cro_.sampa_tester_mode) {
            ...
            gbt_->setTxIdlePattern(0x10000, 0x0000ffff, 0xffffffff);
            gbt_->setTxControlPattern(0x10000, 0x0000ff00, 0x000fffff);
        }
        ...
        switch (cro_.data_type_mode) {
            ...
            case 1:
            case 2:
                expected_event_size_ = static_cast<ssize_t>(cro_.readout_frame_count + 2) << 4;
                break;
            case 3:
                expected_event_size_ = static_cast<ssize_t>(2 * cro_.readout_frame_count + 2) << 4;
                break;
        }
